...
export const GET_RESTAURANTS_LIST  = "https://www.swiggy.com/dapi/restaurants/list/v5?lat=17.4436222&lng=78.3519638&page_type=DESKTOP_WEB_LISTING";
export const GET_RESTAURANT_MENU = "https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=17.3593657&lng=78.51462409999999&restaurantId=";

export const SHIMMER_RES_CARDS_COUNT  = 8;
export const SHIMMER_MENU_ITEMS_COUNT = 4;

/* Github - username, blog name */ 
export const GITHUB_USER_NAME = "SriyaD"
export const GITHUB_BLOG_NAME = "Namaste_React_Learnings"

/* Github API getuser */ 
export const GITHUB_GET_USER = "https://api.github.com/users/";

/* Social Media Links */ 
export const GITHUB_LINK = "https://github.com/SriyaD"  ;
export const LINKEDIN_LINK= "https://www.linkedin.com/in/sriya-datla/" ;
export const GMAIL_LINK  = "mailto:sriyadatla2001@gmail.com";
